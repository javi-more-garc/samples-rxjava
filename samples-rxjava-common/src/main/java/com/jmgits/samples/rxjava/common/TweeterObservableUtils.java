 ...
 */
public final class TweeterObservableUtils {

    public static final int DEFAULT_MESSAGES = 10;

    public static Observable<Tweet> simulateOneThatCompletes() {
        return simulateOneThatCompletes(DEFAULT_MESSAGES);
    }

    public static Observable<Tweet> simulateOneThatCompletes(final int numTweets) {
    ...
    public static Observable<Tweet> simulateOneThatFails() {
    ...
    private TweeterObservableUtils(){
    }
